...
export function getAttributes(gl: WebGL2RenderingContext, program: WebGLProgram): Map<string, GLint> {
...
export function getUniforms(gl: WebGL2RenderingContext, program: WebGLProgram): Map<string, WebGLUniformLocation> {
