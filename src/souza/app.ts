...
import { ColliderSystem } from "./systems/box-collider-system";
...
await resourceManager.loadImages({
  ...
  grassFlowersMushrooms:
    "/LightBorne/Environment/Vegetation/grass, flowers & mushrooms.png",
...
systems.addSystem(cameraSystem(engine2d.getContext(), player));
...
time.on("render", () => {
  ...
  Gizmos.render(engine2d.getContext());
  Gizmos.clear();
});
